...
public class HAJobTracker{
	...
	public void initialize(JobConf conf) throws IOException {
		...
		les.setConnectString(conf.get("jobtracker.zookeeper.quorum"));
		les.setSessionTimeout(conf.getInt("jobtracker.zookeeper.timeout", 6) * 1000);
